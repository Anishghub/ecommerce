            ...
            <div className="container-fluid fixed-top">
                <div className="container topbar bg-primary d-none d-lg-block">
                    <div className="d-flex justify-content-between top-info ps-2">
                        <small><i className="fa fa-map-marker me-2 text-light"></i> <a target='_blank' rel="noreferrer" href="#" className="text-white">GNIT Knowledge park-2</a></small>
                        <small><i className="fa fa-envelope me-2 text-light"></i><a target='_blank' rel="noreferrer" href="mailto:anishsingh77177@gmail.com" className="text-white">anishsingh77177@gmail.com</a></small>
                        <small><i className="fa fa-phone me-2 text-light"></i><a target='_blank' rel="noreferrer" href="tel:7717761569" className="text-white">+91-7717761569</a></small>
                        <small><i className="fa fa-whatsapp me-2 text-light"></i><a target='_blank' rel="noreferrer" href="https://wa.me/7717761569" className="text-white">+91-7717761569</a></small>
                    </div>
                </div>
