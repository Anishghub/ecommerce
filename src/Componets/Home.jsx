...
import { getProduct } from "../Store/ActionCreater/ProductActionCreaters"
...
export default function Home() {
    ...
    function getAPIData() {
        ...
        if (ProductStateData.length) {
            setAllProducts(ProductStateData.reverse().slice(0, 12))
            setMaleProducts(ProductStateData.reverse().filter((x) => x.maincategory === "Male").slice(0, 12))
            setFemaleProducts(ProductStateData.reverse().filter((x) => x.maincategory === "Femle").slice(0, 12))
            setKidsProducts(ProductStateData.reverse().filter((x) => x.maincategory === "Kids").slice(0, 12))
        }
    }
    useEffect(() => {
        getAPIData()
                ...
                <div className="container py-5">
                    <div className="row g-5 align-items-center">
                        <div className="col-md-12 col-lg-7">
                            <h4 className="mb-3 text-primary">Get Upto 90% Discount on Latest Trending Fashion </h4>
                            <h1 className="mb-5 display-3 text-primary"> Tops and Trusted Branded Product</h1>
                            ...
                            <div id="carouselId" className="carousel slide position-relative" data-bs-ride="carousel">
                                <div className="carousel-inner" role="listbox">
                                    <div className="carousel-item active rounded">
                                        <img src="/img/kids.webp" className="img-fluid w-100 h-100 bg-primary rounded" alt="First slide" />
                                        <Link to="/shop/Male" className="btn px-4 py-2 text-white rounded">Shop</Link>
                                    </div>
                                    <div className="carousel-item rounded">
                                        <img src="/img/cucci.jpg" className="img-fluid w-100 h-100 rounded" alt="Second slide" />
                                        <Link to="/shop/Female" className="btn px-4 py-2 text-white rounded">Shop</Link>
                                    </div>
                                    <div className="carousel-item rouo-img-1.pngnded">
                                        <img src="/img/red.jpg " className="img-fluid w-100 h-100 rounded" alt="Second slide" />
                                        <Link to="/shop/Kids" className="btn px-4 py-2 text-white rounded">Shop</Link>
                                    </div>
                                </div>
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-lg-3">
                            <div className="featurs-item text-center rounded bg-light p-4">
                                ...
                                <div className="featurs-content text-center">
                                    <h5>Free Shipping</h5>
                                    <p className="mb-0">Free on order over &#8377;100</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3">
                        ...
                        <div className="col-md-6 col-lg-3">
                            <div className="featurs-item text-center rounded bg-light p-4">
                                ...
                                <div className="featurs-content text-center">
                                    <h5> 07 Day Return</h5>
                                    <p className="mb-0">07 day money guarantee</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3">
                                            ...
                                            return <div key={index} className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    <div className="fruite-img">
                                                        <img src={`/product-images/${item.pic1.webp}`} style={{ height: 250, width: "100%" }} className="img-fluid w-100 rounded-top" alt="" />
                                                    </div>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="row g-4">
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    <div className="fruite-img">
                                                        <img src="/img/best-product-3.jpg" className="img-fluid w-100 rounded-top" alt="" />
                                                    </div>
                                ...
                                <div className="service-item bg-primary rounded border border-primary">
                                    ...
                                    <div className="px-4 rounded-bottom">
                                        <div className="service-content bg-light text-center p-4 rounded">
                                            <h5 className="text-dark">Fresh Apples</h5>
                                ...
                                <div className="service-item bg-primary rounded border border-primary">
                                    ...
                                    <div className="px-4 rounded-bottom">
                                        <div className="service-content bg-light text-center p-4 rounded">
                                            ...
                                            <h3 className="mb-0 text-dark">Discount 30$</h3>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div className="row g-4 align-items-center">
                        <div className="col-lg-6">
                            <div className="py-4">
                                ...
                                <a href="#" className="banner-btn btn border-2 border-white rounded-pill text-light py-3 px-5">BUY</a>
                            </div>
                        </div>
                        <div className="col-lg-6">
