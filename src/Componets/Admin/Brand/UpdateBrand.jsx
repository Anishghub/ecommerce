...
import { getBrand, updateBrand } from "../../../Store/ActionCreater/BrandActionCreaters"
          ...
          <div className="col-md-9">
            ...
            <form onSubmit={postData}>
              <div className="mb-3">
                ...
                <input type="text" name="name" onChange={getInputData} className='form-control' value={name} placeholder='Main Category' />
