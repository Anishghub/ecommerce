...
import { deleteTestimonial, getTestimonial } from "../../../Store/ActionCreater/TestimonialActionCreaters"
...
export default function Testimonial() {
   ...
   const columns = [
  ...
  },
    {
      ...
      headerName: 'Edit',
      sortable: false,
      renderCell: ({ row }) => <Link to={`/admin/testimonial/update/${row.id}`}><i className='fa fa-edit text-primary'></i></Link>  //edit link which is not working
    },
    {
      field: 'delete',
      headerName: 'Delete',
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-9">
            <h4 className='bg-primary text-center text-light p-2'>Testimonial  <Link to="/admin/testimonial/create"> <i className='fa fa-plus text-light float-end'></i></Link></h4>
